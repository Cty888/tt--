<template>
    <div class="shop-header">
        ...
        <div class="shop-header-discounts" v-if="info.supports" @click="toggleSupportShow">     <!--解决办法，异步，初始时info.supports为空，无数据，不应该解析，
                                                                            需要异步后当不为0时解析。二级表达式时没有问题，如info.name
                                                                            三级表达式时就有问题-->
    ...
    .shop-header
        ...
        .shop-brief-modal
            ...
            .brief-modal-content
                ...
                z-index 99
                display flex
                flex-direction column        //使元素从上往下排列
                .content-title
                    font-size 20px
                    line-height 24px
                    font-weight 700
